...
<div class="mt-4 clearfix">
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <h2>Fiche Fournisseur : {{ $fournisseur->nom_fournisseur }}</h2>
        ...
        @endif
        <form method="POST" id="form_edit" action="{{ route('fournisseurs.update', ['fournisseur' => $fournisseur]) }}">
            @csrf
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="code_fournisseur">Code du fournisseur <span class="etoile">*</span></label>
                    <input id="code_fournisseur" type="text" class="form-control @error('code_fournisseur') is-invalid @enderror" name="code_fournisseur" value="{{ old('code_fournisseur') ?? $fournisseur->code_fournisseur }}" required autocomplete="code_fournisseur" autofocus>
                ...
                <label for="nom_fournisseur">Raison sociale <span class="etoile">*</span></label>
                    <input id="nom_fournisseur" type="text" class="form-control @error('nom_fournisseur') is-invalid @enderror" name="nom_fournisseur" value="{{ old('nom_fournisseur') ?? $fournisseur->nom_fournisseur }}" required autocomplete="nom_fournisseur" autofocus>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input id="fixe" type="text" class="form-control @error('fixe') is-invalid @enderror" name="fixe" value="{{ old('fixe') ?? $fournisseur->fixe }}" autocomplete="fixe" autofocus>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input id="fax" type="text" class="form-control @error('fax') is-invalid @enderror" name="fax" value="{{ old('fax') ?? $fournisseur->fax }}" autocomplete="fax" autofocus>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') ?? $fournisseur->email }}" autocomplete="email" autofocus>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input id="siteweb" type="text" class="form-control @error('siteweb') is-invalid @enderror" name="siteweb" value="{{ old('siteweb') ?? $fournisseur->siteweb }}" autocomplete="siteweb" autofocus>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea id="remarques" class="form-control @error('remarques') is-invalid @enderror" name="remarques" >{{ old('remarques') ?? $fournisseur->remarques }}</textarea>
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <table class="table table-striped table-bordered contacts mt-4 @if (count($fournisseur->contacts)==0) {{'d-none'}}@endif">
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <table class="table table-striped table-bordered adresses mt-4 @if (count($fournisseur->adresses)==0) {{'d-none'}}@endif">
            <thead class="thead-dark">
                <th>Libellé</th>
                <th>Adresse</th>
                <th>Ville</th>
            ...
            <tbody>
            @foreach ($fournisseur->adresses as $adresse)
                <tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="form_contact" action="">
                        @csrf
                        <input type="hidden" name="contactable_id" value="{{ $fournisseur->id }}">
                        <input type="hidden" name="contactable_type" value="App\Fournisseur">
    ...
    <div class="modal" id="modal_adresse" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"></h5>
                ...
                <div class="modal-body">
                    <form method="POST" id="form_adresse" action="">
                        @csrf
                        <input type="hidden" name="adresseable_id" value="{{ $fournisseur->id }}">
                        <input type="hidden" name="adresseable_type" value="App\Fournisseur">
    ...
    <script text="javascript">
        ...
        $('#form_contact').on("click",'.add',function(event){
            ...
            $.ajax({
                method : "POST",
                data : formData,
                url : "{{ route('fournisseurs.contacts.add') }}",             
                dataType : "json",
                cache : false,
        ...
        $('#form_contact').on("click",'.update',function(event){
            ...
            $.ajax({
                method : "POST",
                data : formData,
                url : "{{ route('fournisseurs.contacts.update') }}",           
                dataType : "json",
                cache : false,
                processData : false,
                contentType : false,
        ...
        $('table.contacts').on("click",'a.supp_contact',function(event){
            ...
            if(confirm("voulez-vous vraiment supprimer ce élément ?")){
                $.ajax({
                    method : "GET",
                    url : "{{ route('fournisseurs.show') }}/contacts/delete/"+id,           
                    dataType : "json",
                    cache : false,
                    processData : false,
                    contentType : false,
        ...
        $('#form_adresse').on("click",'.add',function(event){
            ...
            $.ajax({
                method : "POST",
                data : formData,
                url : "{{ route('fournisseurs.adresses.add') }}",             
                dataType : "json",
                cache : false,
                processData : false,  // tell jQuery not to process the data
                contentType : false,   // tell jQuery not to set contentType
        ...
        $('#form_adresse').on("click",'.update',function(event){
            ...
            $.ajax({
                method : "POST",
                data : formData,
                url : "{{ route('fournisseurs.adresses.update') }}",           
                dataType : "json",
                cache : false,
                processData : false,
                contentType : false,
        ...
        $('table.adresses').on("click",'a.supp_adresse',function(event){
            ...
            if(confirm("voulez-vous vraiment supprimer ce élément ?")){
                $.ajax({
                    method : "GET",
                    url : "{{ route('fournisseurs.show') }}/adresses/delete/"+id,           
                    dataType : "json",
                    cache : false,
                    processData : false,
                    contentType : false,
